      ...
      <div className="page-shell grid gap-12 border-t border-slate-300/80 pt-12 lg:grid-cols-12 lg:gap-16 lg:pt-16">
        <div className="lg:col-span-4">
          <div className="lg:sticky lg:top-28">
            <h2 className="font-display max-w-[13ch] text-[clamp(2.35rem,4vw,4.25rem)] font-semibold leading-[0.98] tracking-[-0.035em] text-slate-950">
        ...
        <div className="lg:col-span-7 lg:col-start-6">
          <p className="font-display max-w-[31ch] text-[clamp(1.55rem,2.4vw,2.35rem)] font-medium leading-[1.18] tracking-[-0.025em] text-slate-900">
          ...
          <div className="mt-12 grid gap-8 border-l-2 border-teal-500 pl-6 sm:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] sm:pl-8">
            <div>
              <p className="text-sm font-semibold text-slate-500">Contract role</p>
