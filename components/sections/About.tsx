        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Experienced Full Stack Developer specializing in JavaScript and
              TypeScript with expertise in modern frameworks. Building scalable,
              performant web applications since 2022.
            </p>

            <p className="text-muted-foreground text-lg leading-relaxed">
              Strong background in precision agriculture, industrial inspection,
              and web platform development with a proven track record of
            ...
            <Card className="bg-card/50 backdrop-blur-sm">
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  {personalInfo.experience.startDate} - Present
                </p>
